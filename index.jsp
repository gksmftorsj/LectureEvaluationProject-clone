...
<body>
	...
	// String 타입이 들어오기 때문에 int 타입으로 변환해야함
	...
	String emailChecked = new UserDAO().getUserEmailChecked(userID);
	if(emailChecked.equals("0")){
		PrintWriter script = response.getWriter();
		script.println("<script>");
...
%>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<!-- navbar라는 id를 가진 요소가 보였다가 보이지 않았다가 해주기 -->
...
%>
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					<%=evaluation.getEvaluationTtitle()%>&nbsp;<small>(<%=evaluation.getLectureYear()%>년
						<%=evaluation.getSemsterDivide()%>)
					</small>
				</h5>
...
%>
					...
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-group">
							<label>제목</label> <input type="text" name="evaluationTitle"
								class="from-control" maxlength="30">
						</div>
						<div class="form-group">
							<label>내용</label>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2018나동빈All Rights Reserved. </footer>
